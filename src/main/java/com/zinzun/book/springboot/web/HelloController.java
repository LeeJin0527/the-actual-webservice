...
import com.zinzun.book.springboot.web.dto.HelloResponseDto;
...
// GetMapping : HTTP Method 인 Get 요청을 받을 수 있는 API를 만들어 준다 예전에는 RequestMapping(method = RequestMethod.GET)으로 사용했음
